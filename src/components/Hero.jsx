    ...
    <section id="home" className="relative min-h-[70vh] grid lg:grid-cols-2 items-center max-w-6xl mx-auto px-4 sm:px-6 py-16 gap-10">
      <div className="relative">
        ...
        <p className="mt-5 text-lg text-gray-700 max-w-prose">
          A celebration of love, resilience, and the endlessly diverse ways families are formed. Follow along as this expecting dad navigates appointments, cravings, and all the magic in between.
        </p>
